...
<div class="no-padding">
		...
		<li><a href="#">Denah Ruangan</a></li>
                   ...
                   <h1 class="text-light">Denah <?php echo $data['nama']; ?> <span class="mif-home place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
					<div class="container">
					<div>
					<div class="image-container bordered block-shadow"> 	
                    <div class="frame"><img src="<?php echo $data['denah']; ?>"></div>
                    </div>
					</div>
					<div class="place-right">
					<a href="lihatruangan.php"><button class="button primary icon-right rounded">
					Kembali
