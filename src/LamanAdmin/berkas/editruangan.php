...
<div class="cell auto-size padding20 bg-white" id="cell-content">
		...
		<li><a href="lihatruangan.php">Ruangan</a></li>
		<li><a href=" ">Edit Ruangan</a></li>
		</ul>
		</div>
					 <hr class="thin bg-grayLighter">
                    <h1 class="text-light">Edit Ruangan<span class="mif-pencil place-right"></span><span class="mif-home place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
					<div class="container">
					<?php
                    $query = mysql_query("SELECT * FROM ruangan WHERE kode_ruangan='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
					<form action="updateruangan.php" method="post" enctype="multipart/form-data" data-role="validator" data-hint-mode="line"
					data-hint-background="bg-red" data-hint-color="fg-white " data-hide-error="5000">
						<table>
			<tr>
				<td width="200" class="text-light">Kode Ruangan</td>
				<td><div class="input-control text full-size">
				<input
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				type="text" name="kode_ruangan" id="kode_ruangan" placeholder ="Kode Ruangan" value="<?php echo $data['kode_ruangan']; ?>" readonly>
			...
			<tr>
				...
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				type="text" name="nama" id="nama" placeholder = "Nama Ruangan" value="<?php echo $data['nama']; ?>" >
				<span class="input-state-error mif-warning"></span>
						<span class="input-state-success mif-checkmark"></span>
				</div></td>
			...
			<tr>
			<td class="text-light">Lokasi</td>
				<td><div class="input-control full-size required" data-role="select" data-placeholder="Pilih Lokasi Lantai" data-allow-clear="true" >
				<select class="full-size" name="lantai" data-validate-func="required" data-validate-hint="Kolom ini belum dipilih!">
			...
			<tr>
				<td class="text-light">Denah</td>
				<td><div class="input-control file" data-role="input">
				<input
				type="file" name ="nama_file" id="nama_file" placeholder="Masukkan Denah" ">
			...
			<tr>
				...
				<a href="lihatruangan.php"><input type="button" class ="button link fg-dark" value="Batal"></a>
				</td>
			</tr>
