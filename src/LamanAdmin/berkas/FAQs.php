...
<div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">FAQs<span class="mif-question place-right"></span></h1>
    ...
    <div class="frame active">
        ...
        <div class="content"><ul class="step-list">
                            <li>
                                <h2 class="no-margin-top">Pilih Menu Input Data Pada App Bar</h2>
                                <hr class="bg-red" />
                                <div>
                                   Memilih tipe inputan yang terdiri atas tiga inputan berbeda yaitu: Input Dosen, Input Ruangan, Input Prodi
                                    <br />
                                    <br />
                                </div>
                            </li>
                            <li>
                                <h2 class="no-margin-top">Mengisi Form Dengan Benar</h2>
                                <hr class="bg-green" />
                                <div>
                                    Isilah form yang disediakan dengan benar, pastikan kode tiap unit unik (berbeda satu sama lainnya)
                                    <br />
                                    <br />
                            ...
                            <li>
                                <h2 class="no-margin-top">Tekan Tombol Simpan</h2>
                                <hr  class="bg-blue"/>
                                <div>
                                    Inputan berhasil disimpan oleh sistem
                                    <br />
                                    <br />
                                    <a href="inputdosen.php"><button class="button alert">Input Dosen</button></a>
									<a href="inputprodi.php"><button class="button primary">Input Prodi</button></a>
									<a href="inputruangan.php"><button class="button success">Input Ruangan</button></a>
                                </div>
                            </li>
                        </ul></div>
    </div>
    <div class="frame">
        <div class="heading">Menyunting Acara Fakultas</div>
