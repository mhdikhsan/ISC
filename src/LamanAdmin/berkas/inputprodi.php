...
<div class="cell auto-size padding20 bg-white" id="cell-content">
					<div>
						...
						<li><a href=" ">Input Prodi</a></li>
						</ul>
						</div>
						<hr class="thin bg-grayLighter">
                    <h1 class="text-light">Input Prodi<span class="mif-pencil place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
					<div class="container">
					<form action="insertprodi.php" method="Post" enctype="multipart/form-data" data-role="validator" data-role="validator" data-hint-mode="line" data-hint-background="bg-red" data-hint-color="fg-white ">
						<table>
					<tr>
				...
				type="text" name="kode_prodi" id="kode_prodi" placeholder ="Kode Prodi" >
			...
			<tr>
				...
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				type="text" name="namaprodi" id="nama" placeholder = "Nama Prodi">
				<span class="input-state-error mif-warning"></span>
						<span class="input-state-success mif-checkmark"></span>
				</div></td>
			...
			<tr>
				...
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				name="visi" id="misi" cols="40" rows="4" placeholder="Masukkan Visi"></textarea>
				<span class="input-state-error mif-warning"></span>
						<span class="input-state-success mif-checkmark"></span>
				</div></td>
			</tr>
			<tr>
				...
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				name="misi" id="misi" cols="40" rows="4" placeholder="Masukkan Misi"></textarea>
				<span class="input-state-error mif-warning"></span>
						<span class="input-state-success mif-checkmark"></span>
				</div></td>
			</tr>
			<tr>
                ...
                <a href = ""><button type="button" class="button link fg-gray ">Reset</button></a>
            </div></td>
			</tr>
