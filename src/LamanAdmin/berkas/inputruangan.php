...
<div class="cell auto-size padding20 bg-white" id="cell-content">
						...
						<li><a href=" ">Input Ruangan</a></li>
						</ul>
						</div>
					 <hr class="thin bg-grayLighter">
                    <h1 class="text-light">Input Ruangan<span class="mif-hammer place-right"></span></h1>
                    <hr class="thin bg-grayLighter">
					<div class="container">
					<form action="insertruangan.php" method="Post" enctype="multipart/form-data" data-role="validator" data-hint-mode="line" data-hint-background="bg-red" data-hint-color="fg-white ">
						<table>
					<tr>
				...
				type="text" name="kode_ruangan" id="kode_ruangan" placeholder ="Kode Ruangan" >
			...
			<tr>
				...
				data-validate-func="required"
				data-validate-hint="Kolom ini masih kosong!" 
				type="text" name="nama" id="nama" placeholder = "Nama Ruangan">
				<span class="input-state-error mif-warning"></span>
						<span class="input-state-success mif-checkmark"></span>
				</div></td>
			...
			<tr>
                ...
                <button class="button small-button lighten primary fg-white rounded">
				Simpan
				</button>
                <a href = ""><button type="button" class="button link fg-gray ">Cancel</button></a>
            </div></td>
			</tr>
